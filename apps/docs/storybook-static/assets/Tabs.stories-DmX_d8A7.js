import{j as u}from"./jsx-runtime-D_zvdyIk.js";import{R as y}from"./iframe-DTIswzZF.js";import{s as p}from"./dd.es-D2PRlcMt.js";import"./index-DonfJes5.js";import"./index-DtdS9d4v.js";const C={title:"UI/Tabs",component:p,tags:["autodocs"],argTypes:{onChange:{action:"tab changed"}}},s=[{key:"home",label:"Главная"},{key:"profile",label:"Профиль"},{key:"settings",label:"Настройки"},{key:"about",label:"О сайте"}],d=e=>{const[g,T]=y.useState(e.isActive);return u.jsx(p,{...e,isActive:g,onChange:o=>{var n;T(o.key),(n=e.onChange)==null||n.call(e,o)}})},a={render:d,args:{tabs:s,isActive:s[0].key,onChange:e=>console.log("Tab changed:",e.key)}},t={render:d,args:{tabs:[],isActive:s[0].key,onChange:e=>console.log("Tab changed:",e.key)}};var r,c,l;a.parameters={...a.parameters,docs:{...(r=a.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: Template,
  args: {
    tabs: defaultTabs,
